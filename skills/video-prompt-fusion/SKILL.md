...
1. 逐张查看 9 张有序新关键帧。人物身份与外观、人物附属物、服装与可穿戴物、手持物、关键商品、其他对象、场景、材质和空间结构只以新关键帧为准。锚点取景、裁切、构图、景别、机位和静态镜头属性只以新关键帧为准；所有静态事实均由新关键帧独占权威。只描述画面可见且跨帧能够支持的视觉事实；不补全画外、遮挡或不可见内容。
