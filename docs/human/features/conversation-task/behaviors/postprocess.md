...
- 固定保持画幅、裁切、机位、镜头、透视、构图、焦点、景深及全局光源方向、软硬、强度、曝光、白平衡、色温、整体色调、全局对比与 tone curve。每帧 `area_weighted_warm_cool_family` 与 `saturation_style` 的整帧面积加权主色盘合同必须保持；局部固有色可变，但大面积新区域不得翻转整帧冷暖感知。
